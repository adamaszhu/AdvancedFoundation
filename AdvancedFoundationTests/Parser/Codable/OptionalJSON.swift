...
enum OptionalJSONKeys: CodingKey {
    case attribute1
    case attribute2
    case attribute3
    case attribute4
...
extension OptionalJSON: Codable {
    
    public init(from decoder: Decoder) throws {
        let container = try decoder ~~> OptionalJSONKeys.self
    ...
    public func encode(to encoder: Encoder) throws {
        let container = encoder ~~> OptionalJSONKeys.self
